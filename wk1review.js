...
// let b = 39
// if (a>b){
//   console.log("a is the largest number that is "+a)
// } else{
//   console.log("b is the largest number that is "+b)
// }
...
// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy //T is 0  first character in string starts at 0 just like an array

//Unicode proves a unique number for every character - interwebs google search
// let text = "Teddy";
...
const whateverQueenBeySaid = {
  ...
  //for (let i = 0, i < whateverQueenBeySaid.length, i++)
